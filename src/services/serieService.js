...
export default class SerieService {
  ...
  async getSeries() {
    const response = await api.get(
      'https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=pt-BR&page=1&with_companies=420|13252|19551|38679|2301&first_air_date.gte=1900-01-01&first_air_date.lte=2030-01-01&sort_by=first_air_date.asc'
    );
